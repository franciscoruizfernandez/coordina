...
function LlistaIncidencies({ incidencies, onSeleccionar }) {
  ...
  // ─── Navegació per teclat a la llista ──────────────────────
  ...
  return (
    <div className="p-4 space-y-4" role="region" aria-label="Llista d'incidències">
      ...
      {/* Llista */}
      <div className="space-y-2" role="list" aria-label="Incidències filtrades">
